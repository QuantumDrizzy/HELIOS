...
| SHM circular frame buffer consumer | `a stale orphan script` | real — runs |
...
nir_preprocess.cu          ← CUDA bilinear resize → float32 normalized
    ...
    ▼
orphan script     ← non-blocking SHM reader
    │  latest frame tensor
    ▼
...
- [khaos-core](https://github.com/QuantumDrizzy/khaos-core) — BCI kernel
